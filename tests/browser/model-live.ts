...
const cases: (SafeCandidate & { expected: boolean })[] = [
  { id: 'adsense', site: 'publisher.example', url: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js', type: 'script', expected: true },
  { id: 'powerad', site: 'publisher.example', url: 'https://powerad.ai/[redacted]/script.js', type: 'script', expected: true },
  { id: 'app', site: 'publisher.example', url: 'https://publisher.example/js/app.js', type: 'script', expected: false },
  { id: 'chat', site: 'publisher.example', url: 'https://st.chatango.com/js/gz/emb.js', type: 'script', expected: false },
  { id: 'video', site: 'publisher.example', url: 'https://video.example/sample.mp4', type: 'media', tag: 'video', expected: false },
  { id: 'consent', site: 'publisher.example', url: 'https://fundingchoicesmessages.google.com/i/[redacted]', type: 'script', expected: false },
